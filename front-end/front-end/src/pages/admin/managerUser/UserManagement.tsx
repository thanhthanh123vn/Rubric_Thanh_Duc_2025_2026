...
import { Search, Plus, Edit, Trash2, Mail, GraduationCap, X, AlertCircle, Save, Loader2 } from 'lucide-react';
...
export default function UserManagement() {
    ...
    }, [currentPage, searchQuery, refreshTrigger]); // Chạy lại khi refreshTrigger thay đổi
            ...
            <div className="md:hidden space-y-3 pb-4 relative">
                ...
                {users.length > 0 ? users.map((user) => (
                    <div key={user.userId} className="bg-white p-4 rounded-2xl shadow-sm border border-slate-200/60 flex flex-col gap-3 relative">
                        {/* Thay thế nút 3 chấm bằng nút Sửa và Xóa trực tiếp trên Mobile để thao tác nhanh */}
