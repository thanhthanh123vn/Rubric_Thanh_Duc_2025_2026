        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="relative h-10 w-10 focus-visible:ring-0 focus-visible:ring-offset-0 rounded-full hover:bg-gray-100">
                    ...
                    {unreadCount > 0 && (
                        <Badge variant="destructive" className="absolute top-0 right-0 px-1.5 py-0.5 text-[10px] min-w-[20px] justify-center">
            ...
            <DropdownMenuContent
                className="w-[calc(100vw-2rem)] sm:w-[400px] rounded-xl shadow-lg border-gray-100 p-0 overflow-hidden"
                align="end"
                sideOffset={8}
            >
                            ...
                            >
                                ...
                                <div className="relative shrink-0">
                                    <Avatar className="h-12 w-12 sm:h-14 sm:w-14 border border-gray-200">
                                        ...
                                        <AvatarFallback className="bg-blue-100 text-blue-700 font-bold text-lg">
                                            {/* Nếu không có avatar, lấy chữ cái đầu của người gửi, mặc định là Hệ thống */}
                                            {n.senderName ? n.senderName.charAt(0).toUpperCase() : "LMS"}
                                        </AvatarFallback>
                                    </Avatar>
                                </div>

                                {/* 2. Phần Nội dung (Ở giữa) */}
                                <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
                                    ...
                                    <p className="text-[13px] sm:text-[14px] text-gray-600 line-clamp-2 leading-snug">
                                        {/* Nếu muốn highlight tên người gửi như FB, bạn có thể tách n.senderName ra và bôi đậm ở đây */}
                                        {n.content || n.message}
                                    </p>
                                ...
                                {/* 3. Dấu chấm xanh báo chưa đọc (Bên phải) */}
