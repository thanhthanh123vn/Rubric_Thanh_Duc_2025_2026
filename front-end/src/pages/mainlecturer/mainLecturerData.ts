...
export const mainLecturerModuleLinks = [
  ...
  { label: "Trợ giảng học kỳ", path: "/mainlecturer/semester", icon: UsersRound },
  { label: "Chế độ giảng viên", path: "/teacher", icon: Presentation },
  {
    ...
    icon: Bell,
    subItems: [
      { label: "Gửi thông báo", path: "/mainlecturer/notifications/send", icon: Send },
      { label: "Thông báo đã gửi", path: "/mainlecturer/notifications/sent", icon: Inbox },
    ],
  },
];
...
export const quickStats = [
  ...
  { label: "Rubric mẫu", value: "32", note: "Được dùng bởi 24 giảng viên", icon: BookOpen, tone: "blue" },
...
export const cloItems = [
  ...
  { code: "CLO4", title: "Đánh giá năng lực", bloom: "Đánh giá", status: "Duyệt", progress: 100 },
];
...
export const rubricTemplates = [
  ...
  },
  {
    id: 2,
    name: "Dự án phần mềm",
    description: "Đánh giá dự án phần mềm gồm mã nguồn, làm việc nhóm và minh chứng",
    tags: ["Teamwork", "Source code", "Evidence"],
    criteria: ["Chất lượng mã", "Làm việc nhóm", "Tài liệu"],
    weight: "35 / 35 / 30",
  },
  {
    id: 3,
    name: "Thuyết trình học phần",
    description: "Đánh giá nội dung, cách trình bày và phần hỏi đáp",
    tags: ["Content", "Delivery", "Q&A"],
    criteria: ["Nội dung", "Trình bày", "Hỏi đáp"],
    weight: "30 / 40 / 30",
  },
];

export const rubricMatrixData = [
  { id: 1, name: "Ma trận OBE - Lập trình", courses: 4, cloCount: 6, criteria: 8, status: "Hoàn tất" },
  { id: 2, name: "Ma trận OBE - Cơ sở dữ liệu", courses: 3, cloCount: 5, criteria: 7, status: "Chờ duyệt" },
  { id: 3, name: "Ma trận OBE - Web", courses: 2, cloCount: 4, criteria: 6, status: "Nháp" },
];

export const bloomLevels = ["Nhớ", "Hiểu", "Vận dụng", "Phân tích", "Đánh giá", "Sáng tạo"].map((level) => ({
  level,
