                ...
                {loading ? (
                    ...
                    rubrics.map((rubric) => (
                        <div
                            ...
                            className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-slate-700 hover:bg-slate-100 transition-colors cursor-pointer"
                        >
                            <h5 className="font-semibold text-md text-slate-800">
                                {rubric.name}
                            </h5>
