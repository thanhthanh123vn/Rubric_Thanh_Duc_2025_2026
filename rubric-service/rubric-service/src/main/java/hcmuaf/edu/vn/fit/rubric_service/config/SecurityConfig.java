    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/rubric-service/course-clo/**").hasRole("MAIN_LECTURER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/rubric-service/course-clo/**").hasRole("MAIN_LECTURER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/rubric-service/course-clo/**").hasRole("MAIN_LECTURER")
